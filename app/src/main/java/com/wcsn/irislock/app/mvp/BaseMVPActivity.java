...
import com.wcsn.irislock.utils.ViewFinderUtils;
...
public abstract class BaseMVPActivity<P extends IPresenter> extends BaseActivity {
    ...
    protected ViewFinderUtils mFinder = null;
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        mFinder = new ViewFinderUtils(BaseMVPActivity.this);
     ...
     * @return 得到ViewFinder
     */
    protected final ViewFinderUtils getViewFinder() {
        return mFinder;
    }
