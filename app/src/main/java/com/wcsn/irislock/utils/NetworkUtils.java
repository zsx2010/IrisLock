...
public class NetworkUtils {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if(connectivity != null) {
            ...
            LoggerUtils.i("-------------$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$-------------");
            LoggerUtils.i("getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if(info != null) {
                for(int i = 0; i < info.length; i ++ ) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
                    LoggerUtils.i("NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    LoggerUtils.i("NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    LoggerUtils.i("NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    LoggerUtils.i("NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
                LoggerUtils.i("\n");
            } else {
                LoggerUtils.i("getAllNetworkInfo is null");
            }
        }
        return false;
    }
