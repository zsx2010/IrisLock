package com.wcsn.irislock.home.utils;
...
public class WeatherJsonUtils {
    ...
    public static List<WeatherBean> getWeatherInfo(String json) {
        ...
        if("1000".equals(status)) {
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                ...
                weatherBean.setTemperature(jsonObj.getAsJsonObject("data").get("wendu").getAsString() + "℃");
    ...
    public static int getWeatherImage(String weather) {
        if (weather.equals("多云") || weather.equals("多云转阴") || weather.equals("多云转晴")) {
        ...
        } else if (weather.equals("雷阵雨") || weather.equals("阵雨") || weather.equals("阵雨转多云")) {
            ...
            return R.drawable.daxue;
                ...
                || weather.equals("特大暴雨") || weather.equals("大暴雨") || weather.equals("暴雨")) {
        ...
        }else if (weather.equals("小雪") || weather.equals("中雪") || weather.equals("阵雪")) {
            return R.drawable.xue;
        } else if (weather.equals("小雨") || weather.equals("中雨") || weather.equals("中到大雨")) {
