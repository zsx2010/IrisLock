...
import com.ImaginationUnlimited.library.app.BaseFragment;
import com.ImaginationUnlimited.library.app.mvp.IPresenter;
...
//WHY DO NOT USE SETARGUMENT?
//    /**
//     * getData:得到传输过来的数据. <br/>
//     *
//     * @return 得到别的模块或者组件传递过来的数据
//     */
...
//     *
//     * @param bundle 启动这个Fragment必须的参数
//     */
