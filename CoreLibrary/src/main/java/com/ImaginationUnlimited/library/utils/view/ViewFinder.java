package com.ImaginationUnlimited.library.utils.view;
...
/**
 * 
 * @describe 查找和设置view,Activity,Window的View的帮助类). 
 * @author 开源，参考<a href="http://www.tuicool.com/articles/YbqIbqU">推库</a>以及
 *          <a href="https://github.com/letcheng/droid-viewfinder">Github</a>
 * @date: 2015年4月13日 下午6:10:52 <br/>
 */
public class ViewFinder {
     ...
     * @return view registered with listener
     */
    public <T extends View> T find(int id,OnClickListener listener){
        T t = find(id);
