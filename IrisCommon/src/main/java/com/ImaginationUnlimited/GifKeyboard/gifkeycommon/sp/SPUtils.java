...
public class SPUtils {
    ...
    private synchronized SharedPreferences getPrefrences() {
        if (null == mSP) {
            //use the context in CoreLibrary instead
            mSP = PreferenceManager.getDefaultSharedPreferences(
                    CoreLibrary.getInstance().getContext());
        }
        return mSP;
    }
    ...
    public synchronized void putLong(String key, long value) {
        getPrefrences().edit().putLong(key, value).commit();
    }
    ...
    public synchronized void putFloat(String key, float value) {
        getPrefrences().edit().putFloat(key, value).commit();
    }
    ...
    public synchronized void putStringSet(String key, Set<String> values) {
        getPrefrences().edit().putStringSet(key, values).commit();
    }
    ...
    public synchronized void putBoolean(String key, boolean value) {
        getPrefrences().edit().putBoolean(key, value).commit();
    }
